...
public class TestNg_MortgageCalc {
    ...
    public void setDriver() throws IOException, BiffException  {
        ...
        driver = Reusable_Library.Reusable_Methods.getDriver();
    ...
    public void getMonthlyPayment() throws WriteException, InterruptedException {
        ...
        for(int i = 1; i < rowCount; i++) {
            ...
            Thread.sleep(2000);
            //enter home value
            Reusable_Library.Reusable_Methods.sendKeys(driver, "//*[@id='homeval']", homeVal, "Home Value");
            //enter down payment
            Reusable_Library.Reusable_Methods.sendKeys(driver, "//*[@id='downpayment']", downPay, "Down Payment");
            //enter the loan amount
            Reusable_Library.Reusable_Methods.sendKeys(driver, "//*[@id='loanamt']", loanAmount, "Loan Amount");
            //select the month
            Reusable_Library.Reusable_Methods.dropDownMenu(driver, "//*[@name='param[start_month]']", startMonth, "Start Month");
            //enter start year
            Reusable_Library.Reusable_Methods.sendKeys(driver, "//*[@id='start_year']", startYear, "Start Year");
            //click on Calculate button
            Reusable_Library.Reusable_Methods.click(driver, "//*[@value='Calculate']", "Calculate");
            Thread.sleep(2000);
            //capture the monthly payment
            String result = Reusable_Library.Reusable_Methods.captureResult(driver, "//*[@class='left-cell']/following::h3[contains(text(),'$')]", "Monthly Payment");
